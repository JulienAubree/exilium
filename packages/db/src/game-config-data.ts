...
export const BUILDINGS = [
  { id: 'mineraiMine', name: 'Mine de minerai', description: 'Produit du minerai, ressource de base.', baseCostMinerai: 60, baseCostSilicium: 15, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 45, maxLevel: null as number | null, categoryId: 'building_extraction', sortOrder: 0, role: 'producer_minerai', flavorText: "Creusant profondement dans la croute planetaire, les foreuses extractrices de minerai constituent la colonne vertebrale de toute economie spatiale.", prerequisites: [] as { buildingId: string; level: number }[], variantPlanetTypes: ['arid', 'gaseous', 'glacial', 'temperate', 'volcanic'] },
  { id: 'siliciumMine', name: 'Mine de silicium', description: 'Produit du silicium.', baseCostMinerai: 48, baseCostSilicium: 24, baseCostHydrogene: 0, costFactor: 1.6, baseTime: 45, maxLevel: null as number | null, categoryId: 'building_extraction', sortOrder: 1, role: 'producer_silicium', flavorText: "Les gisements de silicium, formes sous des pressions immenses, alimentent l'ensemble des technologies avancees de la galaxie.", prerequisites: [], variantPlanetTypes: ['arid', 'gaseous', 'glacial', 'temperate', 'volcanic'] },
  { id: 'hydrogeneSynth', name: "Synthétiseur d'hydrogène", description: "Produit de l'hydrogène.", baseCostMinerai: 225, baseCostSilicium: 75, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 45, maxLevel: null as number | null, categoryId: 'building_extraction', sortOrder: 2, role: 'producer_hydrogene', flavorText: "L'hydrogene, element fondamental de l'univers, est extrait des oceans planetaires par un processus de filtration moleculaire.", prerequisites: [], variantPlanetTypes: ['arid', 'gaseous', 'glacial', 'temperate', 'volcanic'] },
  { id: 'solarPlant', name: 'Centrale solaire', description: "Produit de l'énergie.", baseCostMinerai: 75, baseCostSilicium: 30, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 45, maxLevel: null as number | null, categoryId: 'building_energie', sortOrder: 0, role: 'producer_energy', flavorText: "D'immenses panneaux photovoltaiques captent l'energie de l'etoile la plus proche pour alimenter l'ensemble des infrastructures planetaires.", prerequisites: [], variantPlanetTypes: ['arid', 'gaseous', 'glacial', 'temperate', 'volcanic'] },
  { id: 'robotics', name: 'Usine de robots', description: 'Réduit le temps de construction des bâtiments.', baseCostMinerai: 400, baseCostSilicium: 120, baseCostHydrogene: 200, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_industrie', sortOrder: 0, role: null, flavorText: "Les chaines de montage automatisees accelerent la construction de tous les batiments et infrastructures.", prerequisites: [] },
  { id: 'shipyard', name: 'Chantier spatial', description: 'Débloque et construit tous les vaisseaux.', baseCostMinerai: 400, baseCostSilicium: 200, baseCostHydrogene: 100, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_industrie', sortOrder: 1, role: null, flavorText: "Le chantier spatial assemble les vaisseaux industriels necessaires a l'expansion de votre empire.", prerequisites: [{ buildingId: 'robotics', level: 1 }] },
  { id: 'arsenal', name: 'Arsenal planétaire', description: 'Débloque et construit les défenses planétaires.', baseCostMinerai: 400, baseCostSilicium: 200, baseCostHydrogene: 100, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_militaire', sortOrder: 0, role: null, flavorText: "L'arsenal planetaire fabrique les systemes de defense qui protegent vos installations contre les attaques ennemies.", prerequisites: [{ buildingId: 'robotics', level: 2 }] },
  { id: 'researchLab', name: 'Laboratoire de recherche', description: 'Permet les recherches.', baseCostMinerai: 200, baseCostSilicium: 400, baseCostHydrogene: 200, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 0, role: null, flavorText: "Au coeur de ce laboratoire, les meilleurs scientifiques de l'empire repoussent les frontieres de la connaissance.", prerequisites: [], allowedPlanetTypes: ['homeworld'] },
  { id: 'storageMinerai', name: 'Entrepôt de minerai', description: 'Augmente le stockage de minerai.', baseCostMinerai: 1000, baseCostSilicium: 0, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_stockage', sortOrder: 0, role: 'storage_minerai', flavorText: "De vastes entrepots blindes permettent de stocker des quantites croissantes de minerai en toute securite.", prerequisites: [] },
  { id: 'storageSilicium', name: 'Entrepôt de silicium', description: 'Augmente le stockage de silicium.', baseCostMinerai: 1000, baseCostSilicium: 500, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_stockage', sortOrder: 1, role: 'storage_silicium', flavorText: "Ces chambres a environnement controle preservent le silicium dans des conditions optimales.", prerequisites: [] },
  { id: 'storageHydrogene', name: "Réservoir d'hydrogène", description: "Augmente le stockage d'hydrogène.", baseCostMinerai: 1000, baseCostSilicium: 1000, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, maxLevel: null as number | null, categoryId: 'building_stockage', sortOrder: 2, role: 'storage_hydrogene', flavorText: "Des reservoirs cryogeniques haute pression maintiennent l'hydrogene a l'etat liquide pour un stockage maximal.", prerequisites: [] },
  { id: 'planetaryShield', name: 'Bouclier planétaire', description: "Génère un champ de force protégeant la planète. Sa puissance est réglable pour économiser l'énergie. La recherche Blindage augmente sa capacité en combat.", baseCostMinerai: 2000, baseCostSilicium: 2000, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 7200, maxLevel: null as number | null, categoryId: 'building_defense', sortOrder: 0, role: 'planetaryShield', flavorText: "Un dôme d'énergie pure enveloppe la planète. En combat, le bouclier est indestructible et se régénère à chaque round. Il ne protège pas votre flotte, mais tant qu'il n'est pas percé, vos défenses planétaires sont intouchables. Sa puissance est réglable dans les paramètres d'énergie.", prerequisites: [] as { buildingId: string; level: number }[], variantPlanetTypes: ['arid', 'gaseous', 'glacial', 'volcanic'] },
  { id: 'labVolcanic', name: 'Forge Volcanique', description: "Annexe de recherche specialisee dans les technologies offensives, exploitant la chaleur extreme du volcanisme.", baseCostMinerai: 8000, baseCostSilicium: 16000, baseCostHydrogene: 8000, costFactor: 2, baseTime: 3600, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 1, role: null, flavorText: "Au coeur des coulees de lave, les forges volcaniques exploitent des temperatures impossibles a reproduire artificiellement pour developper des armes devastatrices.", prerequisites: [{ buildingId: 'researchLab', level: 6 }], allowedPlanetTypes: ['volcanic'] },
  { id: 'labArid', name: 'Laboratoire Aride', description: "Annexe de recherche specialisee dans les materiaux de blindage, tirant parti des mineraux rares du desert.", baseCostMinerai: 8000, baseCostSilicium: 16000, baseCostHydrogene: 8000, costFactor: 2, baseTime: 3600, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 2, role: null, flavorText: "Les conditions extremes du desert permettent de tester des alliages sous des contraintes thermiques et abrasives uniques.", prerequisites: [{ buildingId: 'researchLab', level: 6 }], allowedPlanetTypes: ['arid'] },
  { id: 'labTemperate', name: 'Bio-Laboratoire', description: "Annexe de recherche specialisee dans l'optimisation de la production, s'appuyant sur la biodiversite locale.", baseCostMinerai: 8000, baseCostSilicium: 16000, baseCostHydrogene: 8000, costFactor: 2, baseTime: 3600, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 3, role: null, flavorText: "La richesse biologique des mondes temperes inspire des procedes d'optimisation energetique et productive sans equivalent.", prerequisites: [{ buildingId: 'researchLab', level: 6 }], allowedPlanetTypes: ['temperate'] },
  { id: 'labGlacial', name: 'Cryo-Laboratoire', description: "Annexe de recherche specialisee dans les technologies defensives, exploitant les proprietes cryogeniques.", baseCostMinerai: 8000, baseCostSilicium: 16000, baseCostHydrogene: 8000, costFactor: 2, baseTime: 3600, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 4, role: null, flavorText: "Les temperatures proches du zero absolu permettent de developper des supraconducteurs et des boucliers d'une efficacite inegalee.", prerequisites: [{ buildingId: 'researchLab', level: 6 }], allowedPlanetTypes: ['glacial'] },
  { id: 'labGaseous', name: 'Nebula-Lab', description: "Annexe de recherche specialisee dans la propulsion, exploitant les courants atmospheriques et les gaz rares.", baseCostMinerai: 8000, baseCostSilicium: 16000, baseCostHydrogene: 8000, costFactor: 2, baseTime: 3600, maxLevel: null as number | null, categoryId: 'building_recherche', sortOrder: 5, role: null, flavorText: "Flottant dans l'atmosphere dense des geantes gazeuses, le Nebula-Lab teste des systemes de propulsion dans des conditions extremes.", prerequisites: [{ buildingId: 'researchLab', level: 6 }], allowedPlanetTypes: ['gaseous'] },
];
...
export const RESEARCH = [
  ...
  { id: 'deepSpaceRefining', name: 'Raffinage en espace lointain', description: "Developpe des techniques de raffinage embarquees qui reduisent les scories lors de l'extraction miniere.", baseCostMinerai: 2000, baseCostSilicium: 4000, baseCostHydrogene: 1000, costFactor: 2, levelColumn: 'deepSpaceRefining', categoryId: 'research_sciences', sortOrder: 10, flavorText: "Des nanofiltres embarques separent les scories du minerai pur directement dans la soute du prospecteur, maximisant chaque voyage.", effectDescription: "Chaque niveau reduit les scories de 15% (multiplicatif). Niveau 15 : ~2.5% de scories restantes.", maxLevel: 15, branchId: 'economy', tier: 3, forkId: null, forkPath: null, prerequisites: { buildings: [], research: [{ researchId: 'rockFracturing', level: 2 }] } },

  // ── Propulsion (linéaire) ──
  { id: 'combustion', name: 'Réacteur à combustion', description: 'Propulsion de base pour les vaisseaux.', baseCostMinerai: 400, baseCostSilicium: 0, baseCostHydrogene: 600, costFactor: 2, levelColumn: 'combustion', categoryId: 'research_propulsion', sortOrder: 3, flavorText: "Les moteurs a combustion interne propulsent les premiers vaisseaux a travers l'espace interstellaire.", effectDescription: "Augmente la vitesse des vaisseaux à combustion avec rendements décroissants : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'propulsion', tier: 1, forkId: null, forkPath: null, prerequisites: { buildings: [{ buildingId: 'researchLab', level: 1 }], research: [{ researchId: 'energyTech', level: 1 }] } },
  { id: 'impulse', name: 'Réacteur à impulsion', description: 'Propulsion avancée.', baseCostMinerai: 2000, baseCostSilicium: 4000, baseCostHydrogene: 600, costFactor: 2, levelColumn: 'impulse', categoryId: 'research_propulsion', sortOrder: 4, flavorText: "Le reacteur a impulsion utilise le principe de reaction nucleaire pour atteindre des vitesses superieures.", effectDescription: "Augmente la vitesse des vaisseaux à impulsion avec rendements décroissants : +158% au niveau 5, +286% au niveau 20, plafond +300%.", maxLevel: 20, branchId: 'propulsion', tier: 2, forkId: null, forkPath: null, prerequisites: { buildings: [{ buildingId: 'researchLab', level: 2 }], research: [{ researchId: 'energyTech', level: 1 }] } },
  // Re-pointed: shielding 5 → impulse 5 (sever dependency on forked research)
  { id: 'hyperspaceDrive', name: 'Propulsion hyperespace', description: 'Propulsion la plus rapide.', baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'hyperspaceDrive', categoryId: 'research_propulsion', sortOrder: 5, flavorText: "En pliant l'espace-temps, la propulsion hyperespace permet de parcourir des distances autrefois inimaginables.", effectDescription: "Augmente la vitesse des vaisseaux hyperespace avec rendements décroissants : +237% au niveau 5, +428% au niveau 20, plafond +450%.", maxLevel: 20, branchId: 'propulsion', tier: 3, forkId: null, forkPath: null, prerequisites: { buildings: [{ buildingId: 'researchLab', level: 7 }], research: [{ researchId: 'energyTech', level: 5 }, { researchId: 'impulse', level: 5 }] } },
  { id: 'gaseousPropulsion', name: 'Propulsion ionique avancee', description: "Les gaz rares des geantes gazeuses alimentent des moteurs d'une vitesse inegalee.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'gaseousPropulsion', categoryId: 'research_propulsion', sortOrder: 24, flavorText: "Des ions lourds extraits de l'atmosphere dense sont acceleres a des vitesses relativistes, propulsant les vaisseaux au-dela de toutes les limites connues.", effectDescription: "Augmente la vitesse de tous les vaisseaux : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'propulsion', tier: 3, forkId: null, forkPath: null, requiredAnnexType: 'gaseous', prerequisites: { buildings: [], research: [{ researchId: 'impulse', level: 3 }] } },

  // ── Armement ──
  { id: 'weapons', name: 'Technologie Armes', description: 'Augmente les dégâts de 10% par niveau.', baseCostMinerai: 800, baseCostSilicium: 200, baseCostHydrogene: 0, costFactor: 2, levelColumn: 'weapons', categoryId: 'research_combat', sortOrder: 6, flavorText: "Chaque avancee en technologie des armes augmente de 10% la puissance de feu de toutes vos unites.", effectDescription: "Augmente les dégâts de toutes les unités avec rendements décroissants : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'armament', tier: 1, forkId: null, forkPath: null, prerequisites: { buildings: [{ buildingId: 'researchLab', level: 4 }], research: [] } },
  { id: 'firepower', name: 'Puissance de feu', description: "Concentre l'énergie des systèmes d'armes pour maximiser les dégâts de chaque tir.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'firepower', categoryId: 'research_combat', sortOrder: 25, flavorText: "Des condensateurs haute densité et des focaliseurs de plasma amplifient la puissance destructrice de chaque salve.", effectDescription: "Augmente les dégâts de toutes les unités avec rendements décroissants : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'armament', tier: 2, forkId: 'armament_spec', forkPath: 'power', prerequisites: { buildings: [], research: [{ researchId: 'weapons', level: 3 }] } },
  { id: 'shieldBreaker', name: 'Perce-bouclier', description: "Développe des munitions spéciales capables d'ignorer une fraction de l'absorption des boucliers ennemis.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'shieldBreaker', categoryId: 'research_combat', sortOrder: 26, flavorText: "Des projectiles à charge polarisée inversée traversent les champs de force en exploitant leurs harmoniques de résonance.", effectDescription: "Chaque niveau ignore 4% de l'absorption bouclier ennemie (cap 60%).", maxLevel: 20, branchId: 'armament', tier: 2, forkId: 'armament_spec', forkPath: 'antishield', prerequisites: { buildings: [], research: [{ researchId: 'weapons', level: 3 }] } },
  { id: 'volcanicWeaponry', name: 'Metallurgie de plasma', description: "Les forges volcaniques permettent de developper des armes d'une puissance superieure.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'volcanicWeaponry', categoryId: 'research_combat', sortOrder: 20, flavorText: "Le plasma en fusion, canalise par des champs magnetiques, produit des projectiles capables de traverser n'importe quel blindage.", effectDescription: "Augmente les dégâts de toutes les unités (cumule avec Armes) : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'armament', tier: 3, forkId: null, forkPath: null, requiredAnnexType: 'volcanic', prerequisites: { buildings: [], research: [{ researchId: 'weapons', level: 3 }] } },

  // ── Défense ──
  { id: 'shielding', name: 'Technologie Bouclier', description: 'Augmente les boucliers de 10% par niveau.', baseCostMinerai: 200, baseCostSilicium: 600, baseCostHydrogene: 0, costFactor: 2, levelColumn: 'shielding', categoryId: 'research_combat', sortOrder: 7, flavorText: "Les generateurs de bouclier creent des champs de force protegeant vos unites des impacts ennemis.", effectDescription: "Augmente les boucliers de toutes les unités avec rendements décroissants : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'defense', tier: 1, forkId: 'defense_doctrine', forkPath: 'shields', prerequisites: { buildings: [{ buildingId: 'researchLab', level: 4 }], research: [{ researchId: 'energyTech', level: 3 }] } },
  { id: 'armor', name: 'Technologie Protection', description: 'Augmente la coque et le blindage de 10% par niveau.', baseCostMinerai: 1000, baseCostSilicium: 0, baseCostHydrogene: 0, costFactor: 2, levelColumn: 'armor', categoryId: 'research_combat', sortOrder: 8, flavorText: "Des alliages toujours plus resistants renforcent la coque et le blindage de toutes vos unites de 10% par niveau.", effectDescription: "Augmente la coque et le blindage de toutes les unités avec rendements décroissants : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'defense', tier: 1, forkId: 'defense_doctrine', forkPath: 'armor', prerequisites: { buildings: [{ buildingId: 'researchLab', level: 2 }], research: [] } },
  { id: 'glacialShielding', name: 'Bouclier cryogenique', description: "Les supraconducteurs cryogeniques permettent de creer des boucliers d'une efficacite inegalee.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'glacialShielding', categoryId: 'research_combat', sortOrder: 23, flavorText: "Des circuits supraconducteurs refroidis a des temperatures proches du zero absolu generent des champs de force d'une stabilite parfaite.", effectDescription: "Augmente les boucliers de toutes les unités (cumule avec Bouclier) : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'defense', tier: 2, forkId: 'defense_doctrine', forkPath: 'shields', requiredAnnexType: 'glacial', prerequisites: { buildings: [], research: [{ researchId: 'shielding', level: 3 }] } },
  { id: 'aridArmor', name: 'Blindage composite', description: "Les mineraux rares du desert permettent de creer des alliages de coque et de blindage ultra-resistants.", baseCostMinerai: 10000, baseCostSilicium: 20000, baseCostHydrogene: 6000, costFactor: 2, levelColumn: 'aridArmor', categoryId: 'research_combat', sortOrder: 21, flavorText: "Des fibres minerales entrelacees avec des nano-polymeres forment un blindage composite capable d'absorber des impacts devastateurs.", effectDescription: "Augmente la coque et le blindage de toutes les unités (cumule avec Protection) : +79% au niveau 5, +143% au niveau 20, plafond +150%.", maxLevel: 20, branchId: 'defense', tier: 2, forkId: 'defense_doctrine', forkPath: 'armor', requiredAnnexType: 'arid', prerequisites: { buildings: [], research: [{ researchId: 'armor', level: 3 }] } },
  { id: 'armoredStorage', name: 'Blindage des hangars', description: 'Renforce les hangars pour protéger une partie des ressources contre le pillage.', baseCostMinerai: 1000, baseCostSilicium: 1000, baseCostHydrogene: 0, costFactor: 2, levelColumn: 'armoredStorage', categoryId: 'research_defense', sortOrder: 50, flavorText: 'Un blindage moléculaire rend une partie du stockage totalement inaccessible aux pilleurs.', effectDescription: 'Chaque niveau augmente de 5% la capacité blindée des hangars, protégeant les ressources du pillage.', maxLevel: 20, branchId: 'defense', tier: 3, forkId: null, forkPath: null, prerequisites: { buildings: [{ buildingId: 'storageMinerai', level: 2 }], research: [] } },
];
...
export const SHIPS = [
  ...
  // Military ships → shipyard (fusion des chantiers, 2026-06-10)
  ...
  ], prerequisites: { buildings: [{ buildingId: 'shipyard', level: 1 }], research: [{ researchId: 'combustion', level: 1 }] } },
  // Re-pointed: armor 2 → weapons 2 (sever dependency on forked research)
  ...
  ], prerequisites: { buildings: [{ buildingId: 'shipyard', level: 3 }], research: [{ researchId: 'weapons', level: 2 }, { researchId: 'impulse', level: 2 }] } },
  ...
  ], prerequisites: { buildings: [{ buildingId: 'shipyard', level: 5 }], research: [{ researchId: 'impulse', level: 4 }, { researchId: 'weapons', level: 3 }] } },
  ...
  ], prerequisites: { buildings: [{ buildingId: 'shipyard', level: 7 }], research: [{ researchId: 'hyperspaceDrive', level: 4 }] } },
];
...
export const BONUS_DEFINITIONS = [
  ...
  { id: 'shipyard__ship_build_time__build_military', sourceType: 'building', sourceId: 'shipyard', stat: 'ship_build_time', percentPerLevel: -15, category: 'build_military', statLabel: 'Temps de construction des vaisseaux' },
  { id: 'weapons__weapons', sourceType: 'research', sourceId: 'weapons', stat: 'weapons', percentPerLevel: 10, category: null, statLabel: 'Dégâts des armes' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'shielding__shielding', sourceType: 'research', sourceId: 'shielding', stat: 'shielding', percentPerLevel: 10, category: null, statLabel: 'Puissance des boucliers' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'armor__armor', sourceType: 'research', sourceId: 'armor', stat: 'armor', percentPerLevel: 10, category: null, statLabel: 'Coque et blindage' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'combustion__ship_speed__combustion', sourceType: 'research', sourceId: 'combustion', stat: 'ship_speed', percentPerLevel: 10, category: 'combustion', statLabel: 'Vitesse des vaisseaux' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'impulse__ship_speed__impulse', sourceType: 'research', sourceId: 'impulse', stat: 'ship_speed', percentPerLevel: 20, category: 'impulse', statLabel: 'Vitesse des vaisseaux' , bonusType: 'asymptotic', softCapMax: 3.0, softCapK: 0.15 },
  ...
  { id: 'volcanicWeaponry__weapons', sourceType: 'research', sourceId: 'volcanicWeaponry', stat: 'weapons', percentPerLevel: 10, category: null, statLabel: 'Degats des armes (Forge Volcanique)' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'aridArmor__armor', sourceType: 'research', sourceId: 'aridArmor', stat: 'armor', percentPerLevel: 10, category: null, statLabel: 'Coque et blindage (Laboratoire Aride)' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  ...
  { id: 'glacialShielding__shielding', sourceType: 'research', sourceId: 'glacialShielding', stat: 'shielding', percentPerLevel: 10, category: null, statLabel: 'Puissance des boucliers (Cryo-Laboratoire)' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  { id: 'gaseousPropulsion__ship_speed', sourceType: 'research', sourceId: 'gaseousPropulsion', stat: 'ship_speed', percentPerLevel: 10, category: null, statLabel: 'Vitesse des vaisseaux (Nebula-Lab)' , bonusType: 'asymptotic', softCapMax: 1.5, softCapK: 0.15 },
  // ── Armement fork bonuses (Step 3) ──
  ...
  { id: 'shieldBreaker__shield_pierce', sourceType: 'research', sourceId: 'shieldBreaker', stat: 'shield_pierce', percentPerLevel: 4, category: null, statLabel: 'Perce-bouclier', bonusType: 'asymptotic', softCapMax: 0.6, softCapK: 0.15 },
];

// ── Universe config additions (respec) ──
// Appended to UNIVERSE_CONFIG in seed-game-config.ts
export const UNIVERSE_CONFIG_ADDITIONS = [
  { key: 'research_respec_base', value: 5, label: 'Coût de base (exilium) pour respec d\'un fork de recherche' },
  { key: 'research_respec_factor', value: 2, label: 'Facteur multiplicatif du coût de respec par respec précédent (coût = base × facteur^respec_count)' },
];

// ── UI label additions (fork names & paths) ──
// Appended to UI_LABELS in seed-game-config.ts
export const UI_LABEL_ADDITIONS = [
  // Fork names
  { key: 'research.fork.economy_yield', label: 'Rendement économique' },
  { key: 'research.fork.armament_spec', label: 'Spécialisation Armement' },
  { key: 'research.fork.defense_doctrine', label: 'Doctrine Défense' },
  { key: 'research.fork.intel_warfare', label: 'Guerre informationnelle' },
  // Fork paths
  { key: 'research.fork.economy_yield.production', label: 'Production' },
  { key: 'research.fork.economy_yield.efficiency', label: 'Efficience' },
  { key: 'research.fork.armament_spec.power', label: 'Puissance' },
  { key: 'research.fork.armament_spec.antishield', label: 'Anti-bouclier' },
  { key: 'research.fork.defense_doctrine.shields', label: 'Boucliers' },
  { key: 'research.fork.defense_doctrine.armor', label: 'Blindage' },
