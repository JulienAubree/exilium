...
const TUTORIAL_QUESTS = [
  ...
  { id: 'quest_16', order: 16, title: "Chasseur d'epaves", narrativeText: "Le recuperateur collecte les debris spatiaux.", conditionType: 'ship_count', conditionTargetId: 'recuperateur', conditionTargetValue: 1, rewardMinerai: 1000, rewardSilicium: 600, rewardHydrogene: 250, conditionLabel: 'Recuperateur x1', chapterId: 'chapter_3', journalEntry: "Jour 68 — Les plans du recuperateur sont prets. Un petit vaisseau pas cher, parfait pour aller gratter les champs de debris avant qu'ils ne se dispersent.", objectiveLabel: 'Recuperateur' },
