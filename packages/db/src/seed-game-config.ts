...
const MISSION_DEFINITIONS = [
  ...
  { id: 'recycle', label: 'Recycler', hint: 'Récupérez les débris en orbite', buttonLabel: 'Recycler', color: '#06b6d4', sortOrder: 6, dangerous: false, requiredShipRoles: ['recycler', 'mini_recycler'], exclusive: true, recommendedShipRoles: null, requiresPveMission: false },
