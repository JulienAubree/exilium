...
const BUILDINGS = [
  ...
  { id: 'missionRelay', name: 'Relais de missions', description: "Avant-poste de coordination construit sur les colonies. Augmente les récompenses des missions PvE selon le biome de la colonie : volcanique → minerai, aride → silicium, gazeuse → hydrogène, tempérée → toutes ressources, glaciale → butin pirate.", baseCostMinerai: 2500, baseCostSilicium: 1500, baseCostHydrogene: 500, costFactor: 1.6, baseTime: 240, categoryId: 'building_exploration', sortOrder: 1, role: null, flavorText: "Chaque relais analyse les ressources spécifiques de son biome pour optimiser le butin rapporté par vos flottes. Cumulez les niveaux pour pousser un axe au maximum, ou diversifiez les biomes pour couvrir toutes les ressources.", prerequisites: [{ buildingId: 'missionCenter', level: 2 }], allowedPlanetTypes: ['volcanic', 'arid', 'temperate', 'glacial', 'gaseous'] },
  {
    id: 'galacticMarket',
