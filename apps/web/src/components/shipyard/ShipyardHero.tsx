        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1 min-w-0 pt-1">
            <div className="flex items-start justify-between gap-3">
              ...
              <Link
                to="/buildings"
                className="shrink-0 inline-flex items-center gap-1.5 rounded-lg bg-primary/10 border border-primary/30 px-3 py-1.5 text-xs font-medium text-primary hover:bg-primary/20 transition-colors"
              >
