...
export function OutpostNotEstablishedSection({
  ...
  return (
    <section className="rounded-xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-amber-900/5 p-6 text-center space-y-4">
      ...
      <p className="text-xs text-muted-foreground">Minimum requis pour etablir l'avant-poste</p>
      ...
      {planetConvoys.length > 0 && (
        <div className="mx-auto max-w-md rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-3 text-left space-y-2">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-emerald-500/15 border border-emerald-500/30 px-2 py-0.5 text-xs font-bold text-emerald-300">
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <span className="text-xs font-semibold text-emerald-300">{missionLabel}</span>
                      {f.originPlanetName && (
                    ...
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs tabular-nums mt-0.5">
