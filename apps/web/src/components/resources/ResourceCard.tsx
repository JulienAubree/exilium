...
interface ResourceCardProps {
  ...
  /** Production rates — used to estimate time-to-affordable on the upgrade cost */
  rates?: CraftRates;
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 px-3 lg:px-4 pb-2 flex items-end justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="text-base lg:text-lg font-bold text-foreground drop-shadow-md">
              {label}
            </span>
          </div>
          <span
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-[11px]">
            ...
            <span
              className={cn(
                'font-mono',
                isFull ? 'text-amber-400 font-semibold' : 'text-foreground',
              )}
            >
