    ...
    <section className="glass-card p-4">
      ...
      <div className="space-y-4">
        ...
        {selectedReport.missionType === 'mine' && (() => {
          ...
          const fleet = selectedReport.fleet as any;
          ...
          return (
            <>
              ...
              <div>
                ...
                <div className="rounded border border-border p-3 space-y-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      {result.fleetExtraction && (
                        <span className="text-[10px] text-muted-foreground">(capacite d'extraction : {result.fleetExtraction.toLocaleString('fr-FR')}/cycle)</span>
                      )}
                    </div>
                    {hasGross ? (
                    ...
                    <p className="ml-7 mt-1 text-[10px] text-muted-foreground/70">
                      Ressources brutes prelevees sur l'asteroide, reparties proportionnellement aux reserves restantes.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-7 mt-1 text-[10px] text-muted-foreground/70">
                      {slagPct > 0
                        ? 'Une partie des ressources est perdue lors du raffinage. Ameliorez Raffinage spatial profond pour reduire ce taux.'
                        : 'Aucune perte ! Votre technologie de raffinage elimine toutes les scories.'}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-7 mt-1 text-[10px] text-muted-foreground/70">
                      {cargoPct >= 95
                        ? 'Soute pleine ! Pour transporter plus, ajoutez des vaisseaux cargo ou ameliorez la capacite de soute.'
                        : cargoPct >= 50
                          ? 'Soute partiellement remplie. Le gisement n\'avait plus assez de ressources pour remplir toute la soute.'
                          : 'Soute faiblement remplie. Le gisement manquait de ressources ou la capacite d\'extraction etait limitee.'}
                    </p>
                  </div>
                  ...
                  <div className="border-t border-border pt-3">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-xs font-semibold text-foreground">Ressources rapportees</span>
                    </div>
              ...
              {result.technologies?.length > 0 && (
                <div>
                  <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Technologies appliquees</h3>
