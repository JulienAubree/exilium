    ...
    updateBuilding: adminProcedure
      .input(z.object({
        ...
        data: z.object({
          ...
          baseCostMetal: z.number().int().optional(),
          baseCostCrystal: z.number().int().optional(),
          baseCostDeuterium: z.number().int().optional(),
    ...
    updateShip: adminProcedure
      .input(z.object({
        ...
        data: z.object({
          name: z.string().optional(),
          description: z.string().optional(),
          costMetal: z.number().int().optional(),
          costCrystal: z.number().int().optional(),
          costDeuterium: z.number().int().optional(),
